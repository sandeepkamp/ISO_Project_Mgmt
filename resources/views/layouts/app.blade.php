                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li id="removable">
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            ...
                            <li><a title="Add New Service" href="{{ route('certifications.create') }}">
                            <img src="{{asset('img/sidebar/add-new-body.png')}}" alt="" style="padding: 8px;"><span class="mini-click-non">Add New Body</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li id="removable">
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            ...
                            <li><a title="Add New Service" href="{{ route('auditmanagement.create') }}">
                            <img src="{{asset('img/sidebar/add-details.png')}}" alt="" style="padding: 8px;"><span class="mini-click-non">Add Details</span></a></li>
                        </ul>
                    </li>

                    <!-- {{--<li id="removable">--}}
                        {{--<a class="has-arrow" href="#" aria-expanded="false"><i class="fa big-icon fa-files-o icon-wrap"></i> <span class="mini-click-non">Certification Information</span></a>--}}
                        {{--<ul class="submenu-angle" aria-expanded="false">--}}
                            {{--<li><a title="ISO Service List" href="{{ route('certificationinfo.index') }}"><i class="fa fa-hand-rock-o sub-icon-mg" aria-hidden="true"></i><span class="mini-sub-pro">Show Details</span></a></li>--}}
                            {{--<li><a title="Add New Service" href="{{ route('certificationinfo.create') }}"><i class="fa fa-plane sub-icon-mg" aria-hidden="true"></i><span class="mini-sub-pro">Add Details</span></a></li>--}}
                        {{--</ul>--}}
                    {{--</li>--}} -->

                    <li id="removable">
                        <a class="has-arrow" href="#" aria-expanded="false">
                        <img src="{{asset('img/sidebar/home5.png')}}" alt="" style="padding: 6px;"><span class="mini-click-non">Audit Information</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
